...
class Vehiculo{
    ...
    let vehiculos = [
        ...
        new Vehiculo("5","Audi","Q5",2020,26250,130000,"SUV","../img/autos/q5.jpeg",0),
        new Vehiculo("6","BMW","X5",2019,27500,160000,"SUV","../img/autos/x5.webp",0),
        new Vehiculo("7","Volvo","XC60",2018,27500,120000,"SUV","../img/autos/xc60.jpeg",0),
        new Vehiculo("8","Mazda","2",2023,2000,8000,"Hatchback","../img/autos/mazda2.jpeg",0),
        new Vehiculo("9","Fiat","500e",2022,5050,100000,"Hatchback","../img/autos/500e.jpeg",0),
        new Vehiculo("10","Mercedes Benz","A45 AMG",2022,5200,250000,"Hatchback","../img/autos/a45.jpeg",0),
        new Vehiculo("11","Mercedes Benz","C250",2020,3500,250000,"Sedan","../img/autos/c250.avif",0),
        new Vehiculo("12","Audi","A8",2021,2250,330000,"Sedan","../img/autos/a8.jpeg",0),
        new Vehiculo("13","Volvo","S60",2022,7500,180000,"Sedan","../img/autos/s60.jpeg",0),
        new Vehiculo("14","BMW","3 Series",2023,500,260000,"Sedan","../img/autos/serie3.png",0),
    ];
